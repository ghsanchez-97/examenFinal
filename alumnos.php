...
<body>
    ...
    mysqli_query($con, "insert into alumnos (No_Carnet,Nombre_Completo,Cedula,Direccion,Telefono,Carrera,Turno,Cursa,Activo) values ('$No_Carnet','$Nombre_Completo',
    '$Cedula','$Direccion','$Telefono','$Carrera','$Turno','$Cursa','$Activo')");
    ?>
